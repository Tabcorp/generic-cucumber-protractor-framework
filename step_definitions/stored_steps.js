...
module.exports = function() {
    ...
    this.Given(/^I store the number of "([^"]*)" as "([^"]*)"$/, function (main_element_name, number_name, next) {
    ...
    this.Then(/^I store the "([^"]*)" number as "([^"]*)"$/, function (main_element_name, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
    ...
    this.When(/^I store the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" as "([^"]*)"$/, function (main_element_index, main_element_name, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
    ...
    this.When(/^I store the "([^"]*)" as "([^"]*)"$/, function (main_element_name, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementToLoad(main_element_selector)
            .then(function (current_element) {
                return waitFor(() => {
    ...
    this.When(/^I store the last "([^"]*)" as "([^"]*)"$/, function (main_element_name, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
    ...
    this.Given(/^I store each "([^"]*)" "([^"]*)" element attribute as "([^"]*)" for the "([^"]*)"$/, function (main_element_name, element_type, name, number_of_elements, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
    ...
    this.Then(/^I store the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" element attribute text as "([^"]*)"$/, function (main_element_index, main_element_name, element_type, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.When(/^I store the "([^"]*)" input value as "([^"]*)"$/, function (main_element_name, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementToLoad(main_element_selector)
            .then(function (current_element) {
                return waitFor(() => {
    ...
    this.Then(/^I store the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" element attribute as "([^"]*)"$/, function (main_element_index, main_element_name, element_type, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.Then(/^the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" "([^"]*)" element attribute contains the stored text for "([^"]*)"$/, function (main_element_index, main_element_name, element_type, element_attribute, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.Then(/^the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" "([^"]*)" element attribute does not contain the stored text for "([^"]*)"$/, function (main_element_index, main_element_name, element_type, element_attribute, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.Then(/^the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" element attribute contains the stored text for "([^"]*)"$/, function (main_element_index, main_element_name, element_type, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.Then(/^the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" "([^"]*)" element attribute does not contain the stored text for "([^"]*)"$/, function (main_element_index, main_element_name, element_type, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function () {
    ...
    this.Then(/^the "([^"]*)" contains the stored "([^"]*)"$/, function (main_element_name, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementToLoad(main_element_selector)
            .then(function (current_element) {
                return waitFor(() => {
    ...
    this.Then(/^the "([0-9]+th|[0-9]+st|[0-9]+nd|[0-9]+rd)" "([^"]*)" contains the stored "([^"]*)"$/, function (main_element_index, main_element_name, name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementAtIndexToLoad(main_index, main_element_selector)
            .then(function (current_element) {
    ...
    this.Then(/^the "([^"]*)" should be "([^"]*)" less than the stored number for "([^"]*)"$/, function (main_element_name, expected_number_difference, name, next) {
        const main_element_selector = pageObjects.elementFor(main_element_name);
        pageObjects.waitForElementToLoad(main_element_selector)
            .then(function () {
                return waitFor(() => {
    ...
    this.Then(/^the "(1st|2nd|3rd|[0-9]+th)" "([^"]*)" number should be "([^"]*)" less than the stored number for "([^"]*)"$/, function (main_element_index, main_element_name, expected_number_difference, stored_name, next) {
        const main_index = parseInt(main_element_index) - 1;
        const main_element_selector = pageObjects.elementFor(main_element_name);
